...
This project is indexed by GitNexus as **harness-init** (1709 symbols, 3747 relationships, 89 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
