...
This project is indexed by GitNexus as **harness-init** (1693 symbols, 3693 relationships, 82 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
