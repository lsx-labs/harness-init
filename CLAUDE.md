...
This project is indexed by GitNexus as **harness-init** (1470 symbols, 3162 relationships, 75 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
