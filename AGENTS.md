...
This project is indexed by GitNexus as **harness-init** (1817 symbols, 3990 relationships, 107 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
