...
This project is indexed by GitNexus as **harness-init** (1600 symbols, 3440 relationships, 78 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
