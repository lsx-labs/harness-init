...
This project is indexed by GitNexus as **harness-init** (1440 symbols, 3100 relationships, 69 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
